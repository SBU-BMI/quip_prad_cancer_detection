...
HEATMAP_VERSION="cancer-prad-beatrice-john-3lasses_combined-thresholded_2020-01-20_han.le@stonybrook.edu"
HEATMAP_TXT_OUTPUT_FOLDER=${BASE_DIR}/data/heatmap_txt_3classes_separate_class/heatmap_txt_3class_thresholded
