...
classn = 3
Or, inds, coor = val_fn_epoch_on_disk(classn, model);    # 3 classes: grade3, grade4+5, benign
...
for idx in range(0, Or_all.shape[0]):
    fid.write('{} {} {} {} {}\n'.format(coor[idx][0], coor[idx][1], Or_all[idx][0], Or_all[idx][1], Or_all[idx][2]))
